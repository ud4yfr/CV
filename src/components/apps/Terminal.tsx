      ...
      <div key={`terminal-input-row-${id}`} flex>
        <div className="w-max hstack space-x-1.5">
          <span text-yellow-200>
            uday@macbook-pro <span text-green-300>{this.getCurDirName()}</span>
          </span>
  ...
  render() {
    return (
      ...
      >
        ...
        <div p="y-2 x-1.5">
          <span className="text-green-300">~$</span> welcome to uday's machine. type{" "}
          <span className="text-red-400">help</span> to see commands, or just start poking
          around.
        </div>
